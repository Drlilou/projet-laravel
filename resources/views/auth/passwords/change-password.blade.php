    ...
    <form  class="form"
        ...
        <div class="row">
            ...
            <div class="col-md-8 form-group">
                ...
                <input id="new-password" type="password" class="form-text"
                       style="background: #4b4949;color: white"    placeholder="new-password"
            ...
            <br><br>
            <div class="col-md-8 form-group">
                <input id="new-password-confirm" type="password" class="form-text"
                       style="background: #4b4949;color: white"   placeholder="new-password-confirm"
